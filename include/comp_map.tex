...
al mapping tra una colonna e la sua successiva. Bisogna memorizzare, per
...
tale che $x$ è il massimo indice, si memorizzano le componenti di $v$ in un
...
ogni colonna $k$:
\begin{itemize}
  \item $start_k$, ovvero il booleano atto a capire il simbolo della prima run
