...
termini di uso di bitvector sparsi e intvector compressi.
...
strutture per il random access e, nel caso di uso dell'$\,\SLP$, per l'uso
...
per mapping e 
threshold con bitvector sparsi. Nel caso di uso degli intvector compressi, si
