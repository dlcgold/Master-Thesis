...
\ref{reschap} si discuteranno i risultati sperimentali ottenuti durante la
...
\chapter{Preliminari}
\label{prechap}
In questo capitolo verranno specificati tutti i concetti fondamentali atti a
comprendere i metodi usati in questa tesi. Verranno, quindi, introdotti i
fondamenti teorici presenti allo stato 
dell'arte che hanno permesso lo sviluppo della tesi.\\
Si introdurranno i \textit{bitvector} e
gli \textit{straight-line programs}, fondamentali per la \textit{run-length
...
introdurrà infine la \textit{Positional Burrows-Wheeler Transform}.
\begin{shaded}
  \noindent
  Si specifica inoltre che, con la notazione $T[i,j]$ si intende la
  sottostringa 
