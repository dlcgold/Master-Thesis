...
sperimentazione sui dati reali della \textit{phase 3} del \textbf{1000 Genome
  Project}. Infine, nel capitolo \ref{conchap}, si trarranno le conclusioni 
...
risultati ottenuti su alcuni pannelli del \textbf{1000
  Genome Project} \cite{1kgp}. \\
La sperimentazione è stata effettuata su una macchina con processore Intel Xeon
E5-2640 V4 ($2.40$ GHz), $756$ GB di RAM, $768$ GB di swap e sistema operativo
Ubuntu 20.04.4 LTS. Tale macchina è stata gentilmente messa a disposizione dalla
