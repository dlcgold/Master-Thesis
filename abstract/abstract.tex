...
l'uso delle $\LCE$ query per il calcolo dell'array $\MS$. Infatti, tramite tale
...
la riga $\row$, terminante in colonna $k$. Infine, è possibile estendere tale
...
essendo 
il suo valore del divergence array calcolato anche tramite la coda della run
