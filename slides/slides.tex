...
\begin{frame}{Qualche confronto in spazio}
  \begin{figure}[H]
    \centering
    \hspace{-0.2cm}\includegraphics[width=0.8\textwidth]{img/bv_vs_iv.pdf}
...
\begin{frame}{Calcolo degli $\SMEM$}
  ...
  \begin{block}{Due macro alternative per il calcolo dell'array $\MS$}
    \begin{enumerate}
      \item usare le threshold e il random access al pannello (ispirandosi a
      MONI - {\footnotesize{\textit{Rossi et al., Journal of Computational
            Biology, 2022}}})  
      \item usare le $\LCE$ query (ispirandosi a
      PHONI - {\footnotesize{\textit{Boucher et al., Data Compression Conference
          (DCC), 2021}}})  
    \end{enumerate}
  \end{block}
\end{frame}
...
\begin{frame}{Performance costruzione strutture dati}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{img/make_time_mem_paper2.pdf}
  \end{figure}
\end{frame}
...
\begin{frame}{Performance calcolo degli $\SMEM$ con 100 query}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{img/exe_time_mem_paper2.pdf}
  \end{figure}
\end{frame}
\begin{frame}{Performance calcolo degli $\SMEM$ per singole query}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{img/exe_time_single_paper2.pdf}
  \end{figure}
\end{frame}
