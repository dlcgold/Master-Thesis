...
\begin{frame}{Un punto di vista per il pangenoma}
  ...
  \only<1>{
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.8\textwidth]{img/full.pdf}
    \end{figure}
  }
\end{frame}
...
\begin{frame}{Calcolo degli $\SMEM$}
  ...
  \begin{block}{Due macro alternative per il calcolo dell'array $\MS$}
    \begin{enumerate}
      ...
      MONI - {\footnotesize{\textit{Rossi et al., Journal of Computational Biology,
          2022}}})  
...
\begin{frame}{Costo in memoria delle componenti}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{img/comp_mem2.pdf}
  \end{figure}
\end{frame}
