...
\setbeamercolor{block body alerted}{bg=nord2,fg=white}

\setbeamercolor{itemize item}{fg=nord2}
...
\title[Algoritmi per la $\RLPBWT$] {\Large{Algoritmi per la trasformata di
...
\institute[] {\normalsize{\textbf{{\color{nord2}Relatore:}}
...
\date[26/10/2022] {\newline \footnotesize{26 Ottobre 2022}}
...
\subsection{Pangenoma e pannello di aplotipi}
  ...
  \only<1>{
    ...
    \begin{block}{Rappresentazioni del pangenoma}
      \begin{itemize}
        ...
        \item \textbf{pannello di aplotipi}
      \end{itemize}
    \end{block}
    
    \begin{block}{Aplotipo}
      %Un \textbf{aplotipo} è  l'
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.85\textwidth]{img/full2.pdf}
    \end{figure}
  }
\end{frame}
...
\begin{frame}{{\small{Trasformata di Burrows--Wheeler posizionale -}} {\scriptsize{\textit{Durbin, Bioinformatics,
  ...
  \only<1>{
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[scale = 0.8]{img/da.pdf}
    \end{figure}
  }
  \only<3>{
    \begin{figure}[H]
      \centering
      \includegraphics[scale = 0.8]{img/run.pdf}
    \end{figure}
  }
  % \only<3>{
  %   \begin{figure}[H]
...
\begin{frame}{Sottostrutture e strutture dati composte per la $\RLPBWT$}
  ...
  \only<1>{
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.75\textwidth]{img/ds2thr.pdf}
    \end{figure}
  } \only<3>{
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.75\textwidth]{img/ds2lce.pdf}
    \end{figure}
  }
\end{frame}
...
\begin{frame}{Considerazioni e sviluppi futuri}
  \begin{block}{Considerazioni finali}
    ...
    \begin{itemize}
      ...
      contro un pannello, è stato raggiunto con risultati interessanti
    \end{itemize}
  \end{block}
...
\begin{frame}{}
  ...
  \begin{block}{}
    \begin{center}
      {\color{nord2}{\large{Grazie per l'attenzione}}}
    \end{center}
  \end{block}
\end{frame}
\appendix
